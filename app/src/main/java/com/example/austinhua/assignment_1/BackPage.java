...
public class BackPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BackNames = findViewById(R.id.spinner);
        adapter = ArrayAdapter.createFromResource(this, R.array.Back_workouts,
                android.R.layout.simple_spinner_item);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        BackNames.setAdapter(adapter);

        BackNames.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                int index = BackNames.getSelectedItemPosition();
                if (index == 0){
                    ...
                    final String exercise = BackNames.getItemAtPosition(i).toString();
                    ...
                    button.setOnClickListener(new View.OnClickListener(){
                        ...
                        public void onClick(View view) {
                            ...
                            myeManager = new ExerciseDatabase(BackPage.this);
                            recInserted = myeManager.addRow(exercise, sets, reps, weight);
                            if (recInserted) {
                                Toast.makeText(BackPage.this,
                                        "Successfully added ",Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(BackPage.this,
