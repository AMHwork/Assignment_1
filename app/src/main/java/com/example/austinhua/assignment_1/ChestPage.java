...
public class ChestPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chestNames = findViewById(R.id.spinner);
        adapter = ArrayAdapter.createFromResource(this, R.array.chest_workouts,
                android.R.layout.simple_spinner_item);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        chestNames.setAdapter(adapter);

        chestNames.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                int index = chestNames.getSelectedItemPosition();
                if (index == 0){
                    ...
                    final String exercise = chestNames.getItemAtPosition(i).toString();
                    ...
                    button.setOnClickListener(new View.OnClickListener(){
                        ...
                        public void onClick(View view) {
                            ...
                            myeManager = new ExerciseDatabase(ChestPage.this);
                            recInserted = myeManager.addRow(exercise, sets, reps, weight);
                            if (recInserted) {
                                Toast.makeText(ChestPage.this,
                                        "Successfully added ",Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(ChestPage.this,
