...
public class ThighPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thigh_page);
        ...
        ThighNames = findViewById(R.id.spinner);
        adapter = ArrayAdapter.createFromResource(this, R.array.Thigh_workouts,
                android.R.layout.simple_spinner_item);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        ThighNames.setAdapter(adapter);

        ThighNames.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                int index = ThighNames.getSelectedItemPosition();
                if (index == 0){
                    ...
                    final String exercise = ThighNames.getItemAtPosition(i).toString();
                    ...
                    button.setOnClickListener(new View.OnClickListener(){
                        ...
                        public void onClick(View view) {
                            ...
                            myeManager = new ExerciseDatabase(ThighPage.this);
                            recInserted = myeManager.addRow(exercise, sets, reps, weight);
                            if (recInserted) {
                                Toast.makeText(ThighPage.this,
                                        "Successfully added ",Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(ThighPage.this,
