...
public class GlutesPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GluteNames = findViewById(R.id.spinner);
        adapter = ArrayAdapter.createFromResource(this, R.array.Glute_workouts,
                android.R.layout.simple_spinner_item);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        GluteNames.setAdapter(adapter);

        GluteNames.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                int index = GluteNames.getSelectedItemPosition();
                if (index == 0){
                    ...
                    final String exercise = GluteNames.getItemAtPosition(i).toString();
                    ...
                    button.setOnClickListener(new View.OnClickListener(){
                        ...
                        public void onClick(View view) {
                            ...
                            myeManager = new ExerciseDatabase(GlutesPage.this);
                            recInserted = myeManager.addRow(exercise, sets, reps, weight);
                            if (recInserted) {
                                Toast.makeText(GlutesPage.this,
                                        "Successfully added ",Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(GlutesPage.this,
