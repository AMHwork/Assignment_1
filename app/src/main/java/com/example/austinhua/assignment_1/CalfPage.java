...
public class CalfPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calf_page);
        ...
        CalfNames = findViewById(R.id.spinner);
        adapter = ArrayAdapter.createFromResource(this, R.array.Calf_workouts,
                android.R.layout.simple_spinner_item);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        CalfNames.setAdapter(adapter);

        CalfNames.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                int index = CalfNames.getSelectedItemPosition();
                if (index == 0){
                    ...
                    final String exercise = CalfNames.getItemAtPosition(i).toString();
                    ...
                    button.setOnClickListener(new View.OnClickListener(){
                        ...
                        public void onClick(View view) {
                            ...
                            myeManager = new ExerciseDatabase(CalfPage.this);
                            recInserted = myeManager.addRow(exercise, sets, reps, weight);
                            if (recInserted) {
                                Toast.makeText(CalfPage.this,
                                        "Successfully added ",Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(CalfPage.this,
